        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4 text-center">
                <div class="card-body">
                    ...
                    <h4 class="fw-bold">{{ $empleado->nomper }}</h4>
                    <h5 class="text-muted">{{ $empleado->apeper }}</h5>
                    <div class="badge bg-primary px-3 mb-2">C.I: {{ $empleado->cedper }}</div>
                    <p class="small text-muted mt-2">
                        <i class="bi bi-envelope-at"></i> {{ $empleado->coreleins ?? $empleado->coreleper }}
                    </p>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2"><strong>RIF:</strong> {{ $empleado->rifper }}</li>
                        <li class="mb-2"><strong>Ingreso:</strong> {{ \Carbon\Carbon::parse($empleado->fecingper)->format('d/m/Y') }}</li>
                        <li class="mb-2"><strong>Antigüedad:</strong> <br><span class="text-primary">{{ $antiguedad }}</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="fs-6">{{ \Carbon\Carbon::parse($empleado->fecnacper)->format('d/m/Y') }}</div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="fs-6">{{ $empleado->telmovper ?? 'No registrado' }}</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small fw-bold text-uppercase">Teléfono Habitación</label>
                            <div class="fs-6">{{ $empleado->telhabper ?? 'No registrado' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="fs-6">{{ $empleado->nacper == 'V' ? 'Venezolano' : 'Extranjero' }}</div>
                        </div>
                    </div>
                </div>
