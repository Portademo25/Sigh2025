    ...
    <div class="row justify-content-center">
        <div class="col-md-8 position-relative">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('rrhh.dashboard') }}" class="btn btn-light shadow-sm rounded-pill px-4 fw-bold text-secondary border">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border-start border-4 border-primary h-100">
                                ...
                                <span class="h3 fw-bold text-primary">Bs. {{ number_format($montoActual, 2, ',', '.') }}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 bg-light rounded-3 border-start border-4 border-secondary h-100">
                                ...
                                <span class="d-block mt-1 fw-bold text-dark">{{ $ultimaActualizacion }}</span>
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('rrhh.cestaticket.update') }}" method="POST" id="formCestaticket">
                        @csrf
                        <div class="mb-4">
