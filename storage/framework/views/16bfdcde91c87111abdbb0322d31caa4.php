...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
               <img src="<?php echo e(asset('images/fona.jpeg')); ?>" alt="FONA Logo" style="height:40px; width:40px; margin-right:10px;">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                       <?php echo e(config('app.name')); ?>

                </a>
                    <?php if(DB::table('settings')->where('key', 'site_offline')->value('value') == '1'): ?>
                               ...
                               <?php echo e(Auth::user()->name); ?> <?php echo e(auth()->user()->apellido); ?>
                                  ...
                                  <?php if(Auth::user()->hasRole('admin')): ?>
                                       <span class="badge bg-danger">Admin</span>
                                            <?php elseif(Auth::user()->hasRole('empleado')): ?>
    ...
    <div class="d-flex align-items-start">
        ...
        <div>
            ...
            <div class="d-flex gap-2">
                ...
                <button onclick="window.location.href='<?php echo e(route('logout')); ?>'" class="btn btn-light btn-sm border">
                    Salir
                </button>
            </div>
        </div>
...
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/layouts/app.blade.php ENDPATH**/ ?>