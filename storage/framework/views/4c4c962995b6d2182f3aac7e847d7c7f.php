                        ...
                        <div class="card-body py-3">
                            <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" class="row g-3 align-items-end">
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <input type="date" name="fecha_inicio" value="<?php echo e($fechaInicio); ?>" class="form-control form-control-sm shadow-sm">
                                </div>
                                <div class="col-md-3 col-sm-6">
                                    <label class="form-label small fw-bold text-muted">Hasta:</label>
                                    <input type="date" name="fecha_fin" value="<?php echo e($fechaFin); ?>" class="form-control form-control-sm shadow-sm">
                                </div>
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn-primary btn-sm px-3 shadow-sm">
                                        <i class="bi bi-filter me-1"></i> Filtrar Panel
                                    </button>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-secondary btn-sm px-3 shadow-sm">
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm text-white bg-success h-100">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <h2 class="fw-bold mb-0"><?php echo e($usuariosActivos ?? '0'); ?></h2>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-light btn-sm w-100 mt-3 text-success fw-bold">Gestionar Usuarios</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="small opacity-75">Hoy: <?php echo e($totalHoy ?? 0); ?></p>
                                        </div>
                                        <i class="bi bi-cloud-download fs-1 opacity-50"></i>
                                    </div>
                                    <h2 class="fw-bold mb-0"><?php echo e($totalPeriodo ?? $totalHoy ?? '0'); ?></h2>
                                    <a href="<?php echo e(route('admin.reportes.menu')); ?>" class="btn btn-light btn-sm w-100 mt-3 text-info fw-bold">Ver Reportes</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm text-white bg-warning h-100">
                                <div class="card-body d-flex flex-column justify-content-between text-dark">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.index')); ?>" class="btn btn-dark btn-sm w-100 mt-3 shadow">Ajustes del Sistema</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                          ...
                                          <div class="card border-0 shadow-sm">
                                               <div class="card-header bg-white fw-bold py-3 d-flex justify-content-between align-items-center">
                                                     <span><i class="bi bi-bar-chart-line me-2 text-primary"></i> Generación Mensual: Planilla ARC</span>
                                                          <span class="badge bg-primary-subtle text-primary border border-primary-subtle">Año <?php echo e(date('Y')); ?></span>
                                                      </div>
                                                      <a href="<?php echo e(route('admin.export.excel', ['fecha_inicio' => $fechaInicio, 'fecha_fin' => $fechaFin])); ?>"
   class="btn btn-success btn-sm px-3 shadow-sm ms-1">
    <i class="bi bi-file-earmark-excel me-1"></i> Exportar a Excel
                                ...
                                <div class="card-body d-flex align-items-center justify-content-center">
                                    <?php if(isset($labelsPie) && count($labelsPie) > 0): ?>
                            ...
                            <div class="card border-0 shadow-sm mb-4 h-100">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush">
                                        <?php $__empty_1 = true; $__currentLoopData = $ultimasDescargas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $descarga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="list-group-item px-3 py-3 small border-0 border-bottom">
                                            <div class="d-flex w-100 justify-content-between align-items-start">
                                                <div>
                                                    <span class="fw-bold text-dark d-block"><?php echo e($descarga->nombre_empleado); ?></span>
                                                    <span class="text-muted"><?php echo e($descarga->tipo_reporte); ?></span>
                                                </div>
                                                <small class="badge bg-light text-muted border fw-normal">
                                                    <?php echo e(\Carbon\Carbon::parse($descarga->created_at)->diffForHumans()); ?>
                                ...
                                <div class="card-footer bg-white text-center py-3">
                                    <a href="<?php echo e(route('admin.historial.descargas')); ?>" class="text-decoration-none small fw-bold">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const dataArc = <?php echo json_encode($arcStats); ?>;
        const dataRecibo = <?php echo json_encode($reciboStats); ?>;
        const dataConstancia = <?php echo json_encode($constanciaStats); ?>;

        // Datos de Torta (Distribución)
        const labelsPie = <?php echo json_encode($labelsPie ?? []); ?>;
        const valuesPie = <?php echo json_encode($datosPie ?? []); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>