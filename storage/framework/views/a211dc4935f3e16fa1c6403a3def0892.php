            ...
            <div class="card card-verify shadow-lg">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <span class="data-value text-uppercase"><?php echo e($registro->nombre_completo); ?></span>
                        <div class="text-muted small">C.I.: V-<?php echo e(number_format($registro->cedula, 0, '', '.')); ?></div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <span class="data-value text-primary"><?php echo e($registro->ano_fiscal); ?></span>
                        </div>
                        <div class="col-6 text-end">
                            <span class="data-label d-block">Fecha de Emisión</span>
                            <span class="data-value" style="font-size: 0.9rem;">
                                <?php echo e(\Carbon\Carbon::parse($registro->fecha_generacion)->format('d/m/Y')); ?>
                        ...
                        <div class="col-12 mt-4">
                            <div class="p-3 bg-light rounded-3 border">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-dark fw-bold">Bs. <?php echo e(number_format($registro->total_remuneracion, 2, ',', '.')); ?></span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="fw-bold text-danger">Total Retenido:</span>
                                    <span class="text-danger fw-bold">Bs. <?php echo e(number_format($registro->total_retencion, 2, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <code class="small text-break"><?php echo e($registro->token); ?></code>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/publico/arc_verificacion_exitosa.blade.php ENDPATH**/ ?>