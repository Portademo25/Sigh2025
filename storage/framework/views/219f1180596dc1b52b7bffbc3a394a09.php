...
<body>
    ...
    <form id="force-logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
        <?php echo csrf_field(); ?>
    </form>
    </div>
        </div>
        <p class="mt-4 text-secondary small">&copy; <?php echo e(date('Y')); ?> - Departamento de Tecnología</p>
    </div>
</body>
</html>
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/errors/maintenance.blade.php ENDPATH**/ ?>