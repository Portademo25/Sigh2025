...
<head>
    <meta charset="UTF-8">
    <title>ARC - <?php echo e($personal->cedper); ?> - Año <?php echo e($ano); ?></title>
    <style>
...
<body>
    ...
    <table class="table-data">
        <tr>
            ...
            <td width="45%"><?php echo e($personal->nomper); ?> <?php echo e($personal->apeper); ?></td>
            <td width="15%" class="bg-light">Cédula:</td>
            <td width="25%">V-<?php echo e(number_format($personal->cedper, 0, '', '.')); ?></td>
        </tr>
    </table>
...
<table class="table-data">
    <tr>
        ...
        <td width="30%"><?php echo e($agente['nombre']); ?></td>
        <td width="20%" class="bg-light">CARGO:</td>
        <td width="30%"><?php echo e($agente['cargo']); ?></td>
    </tr>
    <tr>
        <td class="bg-light">ENTE / INSTITUCIÓN:</td>
        <td><?php echo e($agente['ente']); ?></td>
        <td class="bg-light">RIF:</td>
        <td><?php echo e($agente['rif']); ?></td>
    </tr>
    <tr>
        <td class="bg-light">CIUDAD / ESTADO:</td>
        <td><?php echo e($agente['ciudad']); ?> / <?php echo e($agente['estado']); ?></td>
        <td class="bg-light">TELÉFONO:</td>
        <td><?php echo e($agente['telefono']); ?></td>
    </tr>
    <tr>
        <td class="bg-light">DIRECCIÓN FISCAL:</td>
        <td colspan="3"><?php echo e($agente['direccion']); ?></td>
    </tr>
</table>
    ...
    <table class="table-data">
        ...
        <tbody>
            <?php $__currentLoopData = $meses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $mesNombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $item = $detalles->firstWhere('mes', $num); ?>
                <tr>
                    <td><?php echo e($mesNombre); ?></td>
                    <td class="text-right"><?php echo e(number_format($item->asignacion ?? 0, 2, ',', '.')); ?></td>
                    <td class="text-right"><?php echo e(number_format($item->ret_islr ?? 0, 2, ',', '.')); ?></td>
                    <td class="text-right"><?php echo e(number_format($item->otras_retenciones ?? 0, 2, ',', '.')); ?></td>
                </tr>
        ...
        <tfoot>
            <tr class="total-row">
                <td>TOTAL ANUAL</td>
                <td class="text-right">Bs. <?php echo e(number_format($detalles->sum('asignacion'), 2, ',', '.')); ?></td>
                <td class="text-right">Bs. <?php echo e(number_format($detalles->sum('ret_islr'), 2, ',', '.')); ?></td>
                <td class="text-right">Bs. <?php echo e(number_format($detalles->sum('otras_retenciones'), 2, ',', '.')); ?></td>
            </tr>
        </tfoot>
    </table>
        ...
        <tr>
            <td width="45%" style="vertical-align: top;">
                ...
                <table class="table-data" style="font-size: 8px;">
                    <tr><td>S.S.O.</td><td class="text-right"><?php echo e(number_format($detalles->sum('monto_sso'), 2, ',', '.')); ?></td></tr>
                    <tr><td>P.I.E.</td><td class="text-right"><?php echo e(number_format($detalles->sum('monto_pie'), 2, ',', '.')); ?></td></tr>
                    <tr><td>F.A.O.V.</td><td class="text-right"><?php echo e(number_format($detalles->sum('monto_faov'), 2, ',', '.')); ?></td></tr>
                    <tr><td>I.N.C.E.S.</td><td class="text-right"><?php echo e(number_format($detalles->sum('monto_inces'), 2, ',', '.')); ?></td></tr>
                    <tr><td>Fondo Pensión</td><td class="text-right"><?php echo e(number_format($detalles->sum('monto_pension'), 2, ',', '.')); ?></td></tr>
                </table>
            </td>
...
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/empleado/reportes/arc_pdf.blade.php ENDPATH**/ ?>