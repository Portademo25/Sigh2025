        ...
        <table class="main-table">
            <tr>
                <td class="header">
                    ...
                    <img src="<?php echo e($message->embed(public_path('images/logo_fona.png'))); ?>" alt="Logo FONA" style="height: 90px; width: auto;">
            ...
            <tr>
                <td class="footer">
                    ...
                    <small>Si tiene problemas con el botón, copie y vea esta URL: <br> <?php echo e($url); ?></small>
                </td>
            </tr>
        </table>
    </div>
...
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/emails/restablecer.blade.php ENDPATH**/ ?>