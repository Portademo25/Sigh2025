...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="https://www.fona.gob.ve" target="_blank">
                <img src="<?php echo e(asset('images/logo_fona.png')); ?>" alt="Logo FONA" class="me-2">
   ...
   <header class="hero-section">
    ...
    <footer class="py-4 text-center border-top">
          <p class="text-muted small">&copy; <?php echo e(date('Y')); ?> Hecho por la Oficina de Tecnología de la Información y Comunicacion</p>
    </footer>
    </footer>
...
<?php /**PATH /var/www/html/Laravel/Sigh2025/resources/views/welcome.blade.php ENDPATH**/ ?>